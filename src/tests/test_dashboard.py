...
from src.dashboard_generator import generate_dashboard_html, infer_asset_category
...
def test_asset_category_inference_for_brokers():
    """Test asset grouping inference for known broker-specific edge cases."""
    cases = [
        (
            'avenue-stock',
            Entry(
                arquivo='Avenue.pdf',
                instituicao='Avenue Securities LLC',
                cnpj_instituicao='',
                ano_calendario=2025,
                secao='Bens e Direitos',
                grupo='03',
                grupo_desc='Bens e direitos (valores mobiliários)',
                codigo='01',
                codigo_desc='GOOGL – Alphabet Inc.',
                fonte_pagadora='Avenue Securities LLC',
                cnpj_fonte='',
                localizacao='249 - Estados Unidos',
                discriminacao='GOOGL – Alphabet Inc.',
                valor_2024=1000,
                valor_2025=1200,
                rendimento=0,
                tipo_rendimento='',
        ...
        (
            ...
            Entry(
                ...
                grupo_desc='Bens e direitos (valores mobiliários)',
                codigo='01',
                codigo_desc='QQQ – Invesco QQQ Trust',
                fonte_pagadora='Avenue Securities LLC',
                cnpj_fonte='',
                localizacao='249 - Estados Unidos',
                discriminacao='QQQ – Invesco QQQ Trust',
                valor_2024=1000,
                valor_2025=1200,
                rendimento=0,
                tipo_rendimento='',
        ...
        (
            ...
            Entry(
                ...
                cnpj_fonte='17.197.385/0001-21',
                localizacao='BR',
                discriminacao='LF Banco Inter 2028',
                valor_2024=1000,
                valor_2025=1200,
                rendimento=0,
                tipo_rendimento='',
        ...
        (
            ...
            Entry(
                ...
                cnpj_fonte='25.354.503/0001-25',
                localizacao='BR',
                discriminacao='Fundo Multimercado Nu Reserva',
                valor_2024=1000,
                valor_2025=1200,
                rendimento=0,
                tipo_rendimento='',
        ...
        (
            ...
            Entry(
                ...
                cnpj_fonte='24.196.726/0001-03',
                localizacao='BR',
                discriminacao='Fundo Multimercado XP Selection',
                valor_2024=1000,
                valor_2025=1200,
                rendimento=0,
                tipo_rendimento='',
        ...
        (
            ...
            Entry(
                ...
                discriminacao='MXRF11 – Ativo em Custódia',
                valor_2024=1000,
                valor_2025=1200,
                rendimento=0,
                tipo_rendimento='',
                irrf=0,
                observacao='Custódia: 100.00 cotas × R$ 12.00',
            ),
            'FIIs',
        ),
        (
            'nubank-cri-not-crypto',
            Entry(
                arquivo='Nubank.pdf',
                instituicao='NuBank',
                cnpj_instituicao='25.354.503/0001-25',
                ...
                codigo='02',
                codigo_desc='Titulos privados',
                fonte_pagadora='NuBank',
                cnpj_fonte='25.354.503/0001-25',
                localizacao='BR',
                discriminacao='CRI Cyrela 2029',
                valor_2024=1000,
                valor_2025=1200,
                rendimento=0,
                tipo_rendimento='',
                irrf=0,
                observacao='Classe listada perto de cripto no informe',
            ),
        ...
        (
            ...
            Entry(
                ...
                secao='Bens e Direitos',
                grupo='04',
                grupo_desc='Titulos e valores mobiliarios',
                codigo='03',
                codigo_desc='Titulos privados',
                fonte_pagadora='Banco Inter',
                cnpj_fonte='17.197.385/0001-21',
                localizacao='BR',
                discriminacao='LCA Safra 2028',
                valor_2024=1000,
                valor_2025=1200,
                rendimento=0,
                tipo_rendimento='',
                irrf=0,
                observacao='Produto comparado com LCI em nota textual',
            ),
        ...
        (
            ...
            Entry(
                ...
                cnpj_fonte='24.196.726/0001-03',
                localizacao='BR',
                discriminacao='Debenture Eneva 2031',
                valor_2024=1000,
                valor_2025=1200,
                rendimento=0,
                tipo_rendimento='',
                irrf=0,
                observacao='Comparativo comercial com LCI',
            ),
        ...
        (
            ...
            Entry(
                ...
                cnpj_fonte='24.196.726/0001-03',
                localizacao='BR',
                discriminacao='CDB Banco XP 2027',
                valor_2024=1000,
                valor_2025=1200,
                rendimento=0,
                tipo_rendimento='',
                irrf=0,
                observacao='Nao deve virar Tesouro Direto',
            ),
            'CDB – Certificado de Depósito Bancário',
        ),
        # ── Real Nubank patterns (grupo 04 / código 02) ─────────────────────
        # The Nubank PDF uses a GENERIC codigo_desc for every entry under
        # code 04/02: "Títulos públicos e privados sujeitos à tributação
        # (Tesouro Direto, CDB, RDB e Outros)".  This string contains
        # "TESOURO", so the old concatenated-text approach incorrectly
        # returned "Tesouro Direto" for all CDB, LCA, DEB entries.
        # The fix: discriminacao is checked first; descricao is ignored.
        (
            'nubank-cdb-real-descricao',
            Entry(
                arquivo='NuBank.pdf',
                instituicao='Nubank',
                ...
                grupo_desc='Titulos e valores mobiliarios',
                codigo='02',
                codigo_desc='Titulos publicos e privados sujeitos a tributacao (Tesouro Direto, CDB, RDB e Outros)',
                fonte_pagadora='Nubank',
                cnpj_fonte='18.236.120/0001-58',
                localizacao='BR',
                discriminacao='CDB BANCO MASTER',
                valor_2024=1000,
                valor_2025=0,
                rendimento=871.86,
                tipo_rendimento='',
        ...
        (
            ...
            Entry(
                ...
                cnpj_fonte='18.236.120/0001-58',
                localizacao='BR',
                discriminacao='DEB CONCESSIONARIA',
                valor_2024=0,
                valor_2025=13961,
                rendimento=0,
                tipo_rendimento='',
        ...
        # ── Tesouro Direto variants via discriminacao ─────────────────────────
        (
            'tesouro-selic-via-discriminacao',
            Entry(
                arquivo='Inter.pdf',
                instituicao='Inter',
                cnpj_instituicao='17.197.385/0001-21',
                ...
                grupo_desc='Titulos e valores mobiliarios',
                codigo='02',
                codigo_desc='Titulos publicos e privados',
                fonte_pagadora='Banco Inter',
                cnpj_fonte='17.197.385/0001-21',
                localizacao='BR',
                discriminacao='Tesouro Selic 2027',
                valor_2024=5000,
                valor_2025=5500,
                rendimento=0,
                tipo_rendimento='',
        ...
        (
            'tesouro-prefixado-via-discriminacao',
            Entry(
                arquivo='XP.pdf',
                instituicao='XP Investimentos',
                cnpj_instituicao='24.196.726/0001-03',
                ...
                cnpj_fonte='24.196.726/0001-03',
                localizacao='BR',
                discriminacao='Tesouro Prefixado 2029',
                valor_2024=2000,
                valor_2025=2200,
                rendimento=0,
                tipo_rendimento='',
    ...
    for case_name, entry, expected in cases:
        assert infer_asset_category(entry) == expected, case_name
