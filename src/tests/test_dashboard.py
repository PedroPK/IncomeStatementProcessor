...
def test_asset_category_inference_for_brokers():
    ...
    cases = [
        ...
        # ── Real Nubank patterns: descricao is the generic IRPF section title
        #    that mentions "Tesouro Direto, CDB, RDB e Outros" — it must NEVER
        #    override what discriminacao says. ──
        (
