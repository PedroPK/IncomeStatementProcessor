"""
Generate Visual Documentation for Dashboard

Creates markdown documentation with visual representations of dashboard
components and example screenshots showing the different tabs and features.
"""
...
def generate_dashboard_documentation():
    """Generate comprehensive dashboard documentation with visual examples."""
    
    doc = """# 📊 Dashboard Interativo — Documentação Visual
...
if __name__ == '__main__':
    doc = generate_dashboard_documentation()
    
    output_path = Path('/Users/pedropk/Downloads/Apps/Development/IDEs/VsWorkspace/IncomeStatementProcessor/DASHBOARD_VISUAL.md')
    output_path.write_text(doc, encoding='utf-8')
    
    print("✅ Documentação visual gerada:")
    print(f"   Arquivo: {output_path}")
    print(f"   Tamanho: {len(doc) / 1024:.1f}KB")
    print(f"   Linhas: {len(doc.splitlines())}")
